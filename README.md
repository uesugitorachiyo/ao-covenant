...
AO Covenant defines and evaluates the contracts, policy decisions, approvals, and trust records that govern AO work. It validates declared side effects, binds decisions to exact inputs, records provenance, and supports revocation and verification. Use Covenant when a run needs an independent decision about what is allowed and which evidence must be retained.

## How it fits in AO

- **Primary responsibility:** Contracts, policy, approvals, trust, provenance, and revocation.
- **Inputs:** Contracts, declared side effects, approval requests, trust material, and run evidence.
- **Outputs:** Policy decisions, approval tickets, event ledgers, verification results, and tamper-evident evidence packs.
- **Upstream:** AO Forge, AO2, and operators requesting an approval decision.
- **Downstream:** AO Forge and AO2, with decision evidence available to observers and evaluators.
