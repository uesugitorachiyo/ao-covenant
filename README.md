...
bundle unless separately gated; invalid fixtures also prove a streaming claim
cannot add execution authority.
...
Covenant approves only cross-repo documentation/readback wording and denies
...
Covenant approves only support-code/eval wording and denies unrestricted
self-modification.
`public_safe_bounded_sandboxed_self_change_support_code_eval_four_attempts`
is proven from AO Foundry PR #222, commit
`9938df55959ac904295fd4d0dc0eddc52626c972`, with tracked public evidence under
`docs/evidence/unrestricted-self-modification-support-code-eval/`. The Covenant
result is `deny_unrestricted_self_modification_allow_support_code_eval`.
The approved public wording is exactly: "AO has public-safe bounded sandboxed
...
evidence under sandbox containment gates. It does not prove unrestricted
...
Covenant preserves adversarial negative-control wording as prior evidence and denies
unrestricted self-modification.
...
Covenant approves only bounded reversible application wording and denies
unrestricted self-modification.
...
Covenant approves only repeated bounded applications wording and denies
unrestricted self-modification.
...
AO Covenant approves only `public_safe_bounded_sandboxed_external_execution_authority_rehearsal_four_attempts` from AO Foundry PR #233, commit
...
Covenant approves only the exact-scope bounded sandboxed rehearsal wording. This does not prove provider-call authority, credential authority,
...
## Authority-Escalation Criteria Decision
